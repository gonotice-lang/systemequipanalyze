...
type DisplayNdrvs struct {
	EDID         map[string]string `json:"_IODisplayEDID"`
	TypeDisName  string            `json:"_name"`
	ProductID    string            `json:"_spdisplays_display-product-id"`
	SerialNumb   uint16            `json:"_spdisplays_display-serial-number2"`
	VendorID     uint16            `json:"_spdisplays_display-vendor-id"`
	Week         uint16            `json:"_spdisplays_display-week"`
	Year         uint16            `json:"_spdisplays_display-year"`
	...
	ConnectType  string            `json:"spdisplays_internal"`
...
type PortDevice struct {
	...
	CurLanes       uint8  `json:"spdisplays_displayport_current_lanes"`
	CurSpread      string `json:"spdisplays_displayport_current_spread"`
	DPCDVer        string `json:"spdisplays_displayport_DPCD_version"`
	ErrLaneZero    uint32 `json:"spdisplays_displayport_errors_lane0"`
	ErrLaneOne     uint32 `json:"spdisplays_displayport_errors_lane1"`
	ErrLaneTwo     uint32 `json:"spdisplays_displayport_errors_lane2"`
	ErrLaneThr     uint32 `json:"spdisplays_displayport_errors_lane3"`
	HDCPCap        string `json:"spdisplays_displayport_hdcp_capability"`
	MaxBand        string `json:"spdisplays_displayport_max_bandwidth"`
	MaxLanes       uint8  `json:"spdisplays_displayport_max_lanes"`
	...
	SinkCount      uint8  `json:"spdisplays_displayport_sink_count"`
	SinkSwVer      string `json:"spdisplays_displayport_sink_sw_version"`
	SinkVen        string `json:"spdisplays_displayport_sink_vendor"`
	VErrLaneZero   uint8  `json:"spdisplays_displayport_valid_error_lane0"`
	VErrLaneOne    uint8  `json:"spdisplays_displayport_valid_error_lane1"`
	VErrLaneTwo    uint8  `json:"spdisplays_displayport_valid_error_lane2"`
	VErrLaneThr    uint8  `json:"spdisplays_displayport_valid_error_lane3"`
}
